...
const PROTECTED = ["/inicio", "/palpites", "/ranking", "/historico", "/agenda", "/senha", "/admin", "/aguardando"];
...
export const config = {
  matcher: ["/inicio/:path*", "/palpites/:path*", "/ranking/:path*", "/historico/:path*", "/agenda/:path*", "/senha", "/admin/:path*", "/aguardando"],
};
